...
func (obj *spannerDB) DropSchema() []string {
	return []string{
		...
		`ALTER TABLE  kvs ALTER key SET DEFAULT (null)`,

		`DROP SEQUENCE IF EXISTS kvs_key`,
...
func (Kv) _Table() string { return "kvs" }
...
func (obj *sqlite3Impl) ReplaceNoReturn_Kv(ctx context.Context,
	kv_key Kv_Key_Field,
	kv_val Kv_Val_Field) (
	err error) {
...
func (obj *sqlite3Impl) All_Kv(ctx context.Context) (
	rows []*Kv, err error) {
...
func (obj *sqlite3Impl) Get_Kv_By_Key(ctx context.Context,
	kv_key Kv_Key_Field) (
	kv *Kv, err error) {
	...
	kv = &Kv{}
	err = obj.driver.QueryRowContext(ctx, __stmt, __values...).Scan(&kv.Key, &kv.Val)
	if err != nil {
...
func (obj *sqlite3Impl) deleteAll(ctx context.Context) (count int64, err error) {
	...
	var __count int64
	__res, err = obj.driver.ExecContext(ctx, "DELETE FROM kvs;")
	if err != nil {
...
func (obj *pgxImpl) ReplaceNoReturn_Kv(ctx context.Context,
	kv_key Kv_Key_Field,
	kv_val Kv_Val_Field) (
	err error) {
	__key_val := kv_key.value()
...
func (obj *pgxImpl) All_Kv(ctx context.Context) (
	rows []*Kv, err error) {
...
func (obj *pgxImpl) Get_Kv_By_Key(ctx context.Context,
	kv_key Kv_Key_Field) (
	kv *Kv, err error) {
...
func (obj *postgresImpl) ReplaceNoReturn_Kv(ctx context.Context,
	kv_key Kv_Key_Field,
	kv_val Kv_Val_Field) (
	err error) {
	__key_val := kv_key.value()
...
func (obj *postgresImpl) All_Kv(ctx context.Context) (
	rows []*Kv, err error) {
...
func (obj *postgresImpl) Get_Kv_By_Key(ctx context.Context,
	kv_key Kv_Key_Field) (
	kv *Kv, err error) {
...
func (obj *cockroachImpl) ReplaceNoReturn_Kv(ctx context.Context,
	kv_key Kv_Key_Field,
	kv_val Kv_Val_Field) (
	err error) {
	__key_val := kv_key.value()
...
func (obj *cockroachImpl) All_Kv(ctx context.Context) (
	rows []*Kv, err error) {
...
func (obj *cockroachImpl) Get_Kv_By_Key(ctx context.Context,
	kv_key Kv_Key_Field) (
	kv *Kv, err error) {
...
func (obj *pgxcockroachImpl) ReplaceNoReturn_Kv(ctx context.Context,
	kv_key Kv_Key_Field,
	kv_val Kv_Val_Field) (
	err error) {
	__key_val := kv_key.value()
...
func (obj *pgxcockroachImpl) All_Kv(ctx context.Context) (
	rows []*Kv, err error) {
...
func (obj *pgxcockroachImpl) Get_Kv_By_Key(ctx context.Context,
	kv_key Kv_Key_Field) (
	kv *Kv, err error) {
...
func (obj *spannerImpl) ReplaceNoReturn_Kv(ctx context.Context,
	kv_key Kv_Key_Field,
	kv_val Kv_Val_Field) (
	err error) {
	__key_val := kv_key.value()
...
func (obj *spannerImpl) All_Kv(ctx context.Context) (
	rows []*Kv, err error) {
...
func (obj *spannerImpl) Get_Kv_By_Key(ctx context.Context,
	kv_key Kv_Key_Field) (
	kv *Kv, err error) {
