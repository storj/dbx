...
func (obj *postgresImpl) Create_DataBlob(ctx context.Context,
	data_blob_id DataBlob_Id_Field) (
	data_blob *DataBlob, err error) {
	__id_val := data_blob_id.value()
...
func (obj *postgresImpl) Create_DataDate(ctx context.Context,
	data_date_id DataDate_Id_Field) (
	data_date *DataDate, err error) {
	__id_val := data_date_id.value()
...
func (obj *postgresImpl) Create_DataFloat(ctx context.Context,
	data_float_id DataFloat_Id_Field) (
	data_float *DataFloat, err error) {
	__id_val := data_float_id.value()
...
func (obj *postgresImpl) Create_DataFloat64(ctx context.Context,
	data_float64_id DataFloat64_Id_Field) (
	data_float64 *DataFloat64, err error) {
	__id_val := data_float64_id.value()
...
func (obj *postgresImpl) Create_DataInt(ctx context.Context,
	data_int_id DataInt_Id_Field) (
	data_int *DataInt, err error) {
	__id_val := data_int_id.value()
...
func (obj *postgresImpl) Create_DataInt64(ctx context.Context,
	data_int64_id DataInt64_Id_Field) (
	data_int64 *DataInt64, err error) {
	__id_val := data_int64_id.value()
...
func (obj *postgresImpl) Create_DataJson(ctx context.Context,
	data_json_id DataJson_Id_Field) (
	data_json *DataJson, err error) {
	__id_val := data_json_id.value()
...
func (obj *postgresImpl) Create_DataSerial(ctx context.Context) (
	data_serial *DataSerial, err error) {
...
func (obj *postgresImpl) Create_DataSerial64(ctx context.Context) (
	data_serial64 *DataSerial64, err error) {
...
func (obj *postgresImpl) Create_DataText(ctx context.Context,
	data_text_id DataText_Id_Field) (
	data_text *DataText, err error) {
	__id_val := data_text_id.value()
...
func (obj *postgresImpl) Create_DataTimestamp(ctx context.Context,
	data_timestamp_id DataTimestamp_Id_Field) (
	data_timestamp *DataTimestamp, err error) {
	__id_val := data_timestamp_id.value()
...
func (obj *postgresImpl) Create_DataUint(ctx context.Context,
	data_uint_id DataUint_Id_Field) (
	data_uint *DataUint, err error) {
	__id_val := data_uint_id.value()
...
func (obj *postgresImpl) Create_DataUint64(ctx context.Context,
	data_uint64_id DataUint64_Id_Field) (
	data_uint64 *DataUint64, err error) {
	__id_val := data_uint64_id.value()
...
func (obj *postgresImpl) Create_DataUtimestamp(ctx context.Context,
	data_utimestamp_id DataUtimestamp_Id_Field) (
	data_utimestamp *DataUtimestamp, err error) {
	__id_val := data_utimestamp_id.value()
...
func (obj *postgresImpl) Paged_DataBlob(ctx context.Context,
	limit int, start *Paged_DataBlob_Continuation) (
	rows []*DataBlob, next *Paged_DataBlob_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataDate(ctx context.Context,
	limit int, start *Paged_DataDate_Continuation) (
	rows []*DataDate, next *Paged_DataDate_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataFloat(ctx context.Context,
	limit int, start *Paged_DataFloat_Continuation) (
	rows []*DataFloat, next *Paged_DataFloat_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataFloat64(ctx context.Context,
	limit int, start *Paged_DataFloat64_Continuation) (
	rows []*DataFloat64, next *Paged_DataFloat64_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataInt(ctx context.Context,
	limit int, start *Paged_DataInt_Continuation) (
	rows []*DataInt, next *Paged_DataInt_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataInt64(ctx context.Context,
	limit int, start *Paged_DataInt64_Continuation) (
	rows []*DataInt64, next *Paged_DataInt64_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataJson(ctx context.Context,
	limit int, start *Paged_DataJson_Continuation) (
	rows []*DataJson, next *Paged_DataJson_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataSerial(ctx context.Context,
	limit int, start *Paged_DataSerial_Continuation) (
	rows []*DataSerial, next *Paged_DataSerial_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataSerial64(ctx context.Context,
	limit int, start *Paged_DataSerial64_Continuation) (
	rows []*DataSerial64, next *Paged_DataSerial64_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataText(ctx context.Context,
	limit int, start *Paged_DataText_Continuation) (
	rows []*DataText, next *Paged_DataText_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataTimestamp(ctx context.Context,
	limit int, start *Paged_DataTimestamp_Continuation) (
	rows []*DataTimestamp, next *Paged_DataTimestamp_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataUint(ctx context.Context,
	limit int, start *Paged_DataUint_Continuation) (
	rows []*DataUint, next *Paged_DataUint_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataUint64(ctx context.Context,
	limit int, start *Paged_DataUint64_Continuation) (
	rows []*DataUint64, next *Paged_DataUint64_Continuation, err error) {
...
func (obj *postgresImpl) Paged_DataUtimestamp(ctx context.Context,
	limit int, start *Paged_DataUtimestamp_Continuation) (
	rows []*DataUtimestamp, next *Paged_DataUtimestamp_Continuation, err error) {
...
func (obj *cockroachImpl) Create_DataBlob(ctx context.Context,
	data_blob_id DataBlob_Id_Field) (
	data_blob *DataBlob, err error) {
	__id_val := data_blob_id.value()
...
func (obj *cockroachImpl) Create_DataDate(ctx context.Context,
	data_date_id DataDate_Id_Field) (
	data_date *DataDate, err error) {
	__id_val := data_date_id.value()
...
func (obj *cockroachImpl) Create_DataFloat(ctx context.Context,
	data_float_id DataFloat_Id_Field) (
	data_float *DataFloat, err error) {
	__id_val := data_float_id.value()
...
func (obj *cockroachImpl) Create_DataFloat64(ctx context.Context,
	data_float64_id DataFloat64_Id_Field) (
	data_float64 *DataFloat64, err error) {
	__id_val := data_float64_id.value()
...
func (obj *cockroachImpl) Create_DataInt(ctx context.Context,
	data_int_id DataInt_Id_Field) (
	data_int *DataInt, err error) {
	__id_val := data_int_id.value()
...
func (obj *cockroachImpl) Create_DataInt64(ctx context.Context,
	data_int64_id DataInt64_Id_Field) (
	data_int64 *DataInt64, err error) {
	__id_val := data_int64_id.value()
...
func (obj *cockroachImpl) Create_DataJson(ctx context.Context,
	data_json_id DataJson_Id_Field) (
	data_json *DataJson, err error) {
	__id_val := data_json_id.value()
...
func (obj *cockroachImpl) Create_DataSerial(ctx context.Context) (
	data_serial *DataSerial, err error) {

	var __embed_stmt = __sqlbundle_Literal("INSERT INTO data_serials ( id ) VALUES ( DEFAULT ) RETURNING data_serials.id")
...
func (obj *cockroachImpl) Create_DataSerial64(ctx context.Context) (
	data_serial64 *DataSerial64, err error) {

	var __embed_stmt = __sqlbundle_Literal("INSERT INTO data_serial64s ( id ) VALUES ( DEFAULT ) RETURNING data_serial64s.id")
...
func (obj *cockroachImpl) Create_DataText(ctx context.Context,
	data_text_id DataText_Id_Field) (
	data_text *DataText, err error) {
	__id_val := data_text_id.value()
...
func (obj *cockroachImpl) Create_DataTimestamp(ctx context.Context,
	data_timestamp_id DataTimestamp_Id_Field) (
	data_timestamp *DataTimestamp, err error) {
	__id_val := data_timestamp_id.value()
...
func (obj *cockroachImpl) Create_DataUint(ctx context.Context,
	data_uint_id DataUint_Id_Field) (
	data_uint *DataUint, err error) {
	__id_val := data_uint_id.value()
...
func (obj *cockroachImpl) Create_DataUint64(ctx context.Context,
	data_uint64_id DataUint64_Id_Field) (
	data_uint64 *DataUint64, err error) {
	__id_val := data_uint64_id.value()
...
func (obj *cockroachImpl) Create_DataUtimestamp(ctx context.Context,
	data_utimestamp_id DataUtimestamp_Id_Field) (
	data_utimestamp *DataUtimestamp, err error) {
	__id_val := data_utimestamp_id.value()
...
func (obj *cockroachImpl) Paged_DataBlob(ctx context.Context,
	limit int, start *Paged_DataBlob_Continuation) (
	rows []*DataBlob, next *Paged_DataBlob_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataDate(ctx context.Context,
	limit int, start *Paged_DataDate_Continuation) (
	rows []*DataDate, next *Paged_DataDate_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataFloat(ctx context.Context,
	limit int, start *Paged_DataFloat_Continuation) (
	rows []*DataFloat, next *Paged_DataFloat_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataFloat64(ctx context.Context,
	limit int, start *Paged_DataFloat64_Continuation) (
	rows []*DataFloat64, next *Paged_DataFloat64_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataInt(ctx context.Context,
	limit int, start *Paged_DataInt_Continuation) (
	rows []*DataInt, next *Paged_DataInt_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataInt64(ctx context.Context,
	limit int, start *Paged_DataInt64_Continuation) (
	rows []*DataInt64, next *Paged_DataInt64_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataJson(ctx context.Context,
	limit int, start *Paged_DataJson_Continuation) (
	rows []*DataJson, next *Paged_DataJson_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataSerial(ctx context.Context,
	limit int, start *Paged_DataSerial_Continuation) (
	rows []*DataSerial, next *Paged_DataSerial_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataSerial64(ctx context.Context,
	limit int, start *Paged_DataSerial64_Continuation) (
	rows []*DataSerial64, next *Paged_DataSerial64_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataText(ctx context.Context,
	limit int, start *Paged_DataText_Continuation) (
	rows []*DataText, next *Paged_DataText_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataTimestamp(ctx context.Context,
	limit int, start *Paged_DataTimestamp_Continuation) (
	rows []*DataTimestamp, next *Paged_DataTimestamp_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataUint(ctx context.Context,
	limit int, start *Paged_DataUint_Continuation) (
	rows []*DataUint, next *Paged_DataUint_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataUint64(ctx context.Context,
	limit int, start *Paged_DataUint64_Continuation) (
	rows []*DataUint64, next *Paged_DataUint64_Continuation, err error) {
...
func (obj *cockroachImpl) Paged_DataUtimestamp(ctx context.Context,
	limit int, start *Paged_DataUtimestamp_Continuation) (
	rows []*DataUtimestamp, next *Paged_DataUtimestamp_Continuation, err error) {
...
func (obj *spannerImpl) Create_DataBlob(ctx context.Context,
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_blob.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataDate(ctx context.Context,
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_date.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataFloat(ctx context.Context,
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_float.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataFloat64(ctx context.Context,
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_float64.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataInt(ctx context.Context,
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_int.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataInt64(ctx context.Context,
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_int64.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataJson(ctx context.Context,
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_json.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataSerial(ctx context.Context) (
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_serial.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataSerial64(ctx context.Context) (
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_serial64.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataText(ctx context.Context,
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_text.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataTimestamp(ctx context.Context,
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_timestamp.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataUint(ctx context.Context,
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_uint.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataUint64(ctx context.Context,
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_uint64.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
...
func (obj *spannerImpl) Create_DataUtimestamp(ctx context.Context,
	...
	err = tx.QueryRowContext(ctx, __stmt, __values...).Scan(&data_utimestamp.Id)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	err = tx.Commit()
