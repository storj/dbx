...
func (obj *postgresImpl) Create_Bar(ctx context.Context,
	bar_a Bar_A_Field,
	bar_b Bar_B_Field,
	optional Bar_Create_Fields) (
	bar *Bar, err error) {
...
func (obj *postgresImpl) Create_Baz(ctx context.Context,
	optional Baz_Create_Fields) (
	baz *Baz, err error) {
...
func (obj *postgresImpl) Create_Minimal(ctx context.Context) (
	minimal *Minimal, err error) {
...
func (obj *postgresImpl) Get_Foo_By_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field) (
	foo *Foo, err error) {
...
func (obj *postgresImpl) Get_Bar_By_Pk(ctx context.Context,
	bar_pk Bar_Pk_Field) (
	bar *Bar, err error) {
...
func (obj *postgresImpl) Get_Baz_By_Pk(ctx context.Context,
	baz_pk Baz_Pk_Field) (
	baz *Baz, err error) {
...
func (obj *cockroachImpl) Create_Bar(ctx context.Context,
	bar_a Bar_A_Field,
	bar_b Bar_B_Field,
	optional Bar_Create_Fields) (
	bar *Bar, err error) {
...
func (obj *cockroachImpl) Create_Baz(ctx context.Context,
	optional Baz_Create_Fields) (
	baz *Baz, err error) {
...
func (obj *cockroachImpl) Create_Minimal(ctx context.Context) (
	minimal *Minimal, err error) {

	var __embed_stmt = __sqlbundle_Literal("INSERT INTO minimals ( pk ) VALUES ( DEFAULT ) RETURNING minimals.pk")
...
func (obj *cockroachImpl) Get_Foo_By_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field) (
	foo *Foo, err error) {
...
func (obj *cockroachImpl) Get_Bar_By_Pk(ctx context.Context,
	bar_pk Bar_Pk_Field) (
	bar *Bar, err error) {
...
func (obj *cockroachImpl) Get_Baz_By_Pk(ctx context.Context,
	baz_pk Baz_Pk_Field) (
	baz *Baz, err error) {
