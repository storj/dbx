...
func (obj *postgresImpl) Create_AssociatedAccount(ctx context.Context,
	associated_account_user_pk AssociatedAccount_UserPk_Field) (
	associated_account *AssociatedAccount, err error) {
	__user_pk_val := associated_account_user_pk.value()
...
func (obj *postgresImpl) All_Session_Id_By_AssociatedAccount_Pk(ctx context.Context,
	associated_account_pk AssociatedAccount_Pk_Field) (
	rows []*Id_Row, err error) {
...
func (obj *cockroachImpl) Create_User(ctx context.Context) (
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT INTO users ( pk ) VALUES ( DEFAULT ) RETURNING users.pk")
...
func (obj *cockroachImpl) Create_AssociatedAccount(ctx context.Context,
	associated_account_user_pk AssociatedAccount_UserPk_Field) (
	associated_account *AssociatedAccount, err error) {
	__user_pk_val := associated_account_user_pk.value()
...
func (obj *cockroachImpl) Create_Session(ctx context.Context,
	session_user_pk Session_UserPk_Field) (
	session *Session, err error) {
	__user_pk_val := session_user_pk.value()
...
func (obj *cockroachImpl) All_Session_Id_By_AssociatedAccount_Pk(ctx context.Context,
	associated_account_pk AssociatedAccount_Pk_Field) (
	rows []*Id_Row, err error) {
