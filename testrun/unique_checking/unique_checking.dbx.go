...
func (obj *postgresImpl) Create_A(ctx context.Context) (
	a *A, err error) {
...
func (obj *postgresImpl) Create_B(ctx context.Context,
	b_a_id B_AId_Field) (
	b *B, err error) {
	__a_id_val := b_a_id.value()
...
func (obj *postgresImpl) Create_C(ctx context.Context,
	c_lat C_Lat_Field,
	c_lon C_Lon_Field,
	c_b_id C_BId_Field) (
	c *C, err error) {
...
func (obj *postgresImpl) All_A_B_C_By_A_Id_And_C_Lat_Less_And_C_Lat_Greater_And_C_Lon_Less_And_C_Lon_Greater(ctx context.Context,
	a_id A_Id_Field,
	c_lat_less C_Lat_Field,
	c_lat_greater C_Lat_Field,
	c_lon_less C_Lon_Field,
...
func (obj *cockroachImpl) Create_A(ctx context.Context) (
	a *A, err error) {

	var __embed_stmt = __sqlbundle_Literal("INSERT INTO a ( id ) VALUES ( DEFAULT ) RETURNING a.id")
...
func (obj *cockroachImpl) Create_B(ctx context.Context,
	b_a_id B_AId_Field) (
	b *B, err error) {
	__a_id_val := b_a_id.value()
...
func (obj *cockroachImpl) Create_C(ctx context.Context,
	c_lat C_Lat_Field,
	c_lon C_Lon_Field,
	c_b_id C_BId_Field) (
	c *C, err error) {
...
func (obj *cockroachImpl) All_A_B_C_By_A_Id_And_C_Lat_Less_And_C_Lat_Greater_And_C_Lon_Less_And_C_Lon_Greater(ctx context.Context,
	a_id A_Id_Field,
	c_lat_less C_Lat_Field,
	c_lat_greater C_Lat_Field,
	c_lon_less C_Lon_Field,
