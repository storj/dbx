...
func (obj *spannerImpl) Create_E(ctx context.Context,
	...
	err = d.QueryRowContext(ctx, __stmt, __values...).Scan(&e.Pk, &e.Id, &e.AId)
	if !obj.txn {
		if err == nil {
...
func (obj *spannerImpl) Create_D(ctx context.Context,
	...
	err = d.QueryRowContext(ctx, __stmt, __values...).Scan(&d.Pk, &d.Id, &d.Alias, &d.Date, &d.EId, &d.AId)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_A(ctx context.Context,
	...
	err = d.QueryRowContext(ctx, __stmt, __values...).Scan(&a.Pk, &a.Ctime, &a.Mtime, &a.Id, &a.Name)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_AB(ctx context.Context,
	...
	err = d.QueryRowContext(ctx, __stmt, __values...).Scan(&a_b.BPk, &a_b.APk)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_C(ctx context.Context,
	...
	err = d.QueryRowContext(ctx, __stmt, __values...).Scan(&c.Pk, &c.Id, &c.BPk)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_B(ctx context.Context,
	...
	err = d.QueryRowContext(ctx, __stmt, __values...).Scan(&b.Pk, &b.Id, &b.Data)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
