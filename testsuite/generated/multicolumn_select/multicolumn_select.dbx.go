...
func Foo_One(v int) Foo_One_Field {
	return Foo_One_Field{_set: true, _value: v}
}

func (f Foo_One_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
func Foo_Two(v int) Foo_Two_Field {
	return Foo_Two_Field{_set: true, _value: v}
}

func (f Foo_Two_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
type One_Two_Row struct {
	One int
	Two int
}

func (obj *sqlite3Impl) All_Foo_One_Foo_Two(ctx context.Context) (
	rows []*One_Two_Row, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT foos.one, foos.two FROM foos")
	...
	for {
		rows, err = func() (rows []*One_Two_Row, err error) {
			...
			for __rows.Next() {
				row := &One_Two_Row{}
				err = __rows.Scan(&row.One, &row.Two)
				if err != nil {
					return nil, err
				}
...
func (obj *pgxImpl) All_Foo_One_Foo_Two(ctx context.Context) (
	rows []*One_Two_Row, err error) {
...
func (obj *pgxcockroachImpl) All_Foo_One_Foo_Two(ctx context.Context) (
	rows []*One_Two_Row, err error) {
...
func (obj *spannerImpl) All_Foo_One_Foo_Two(ctx context.Context) (
	rows []*One_Two_Row, err error) {
...
type Methods interface {
	All_Foo_One_Foo_Two(ctx context.Context) (
		rows []*One_Two_Row, err error)
}
