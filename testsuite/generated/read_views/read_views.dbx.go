...
func (obj *sqlite3Impl) All_Foo(ctx context.Context) (
	...
	var __embed_stmt = __sqlbundle_Literal("SELECT foos.id FROM foos")
...
func (obj *sqlite3Impl) Limited_Foo(ctx context.Context,
	...
	var __embed_stmt = __sqlbundle_Literal("SELECT foos.id FROM foos LIMIT ? OFFSET ?")
...
func (obj *sqlite3Impl) Paged_Foo(ctx context.Context,
	...
	var __embed_stmt = __sqlbundle_Literal("SELECT foos.id, foos.id FROM foos WHERE (foos.id) > ? ORDER BY foos.id LIMIT ?")

	var __embed_first_stmt = __sqlbundle_Literal("SELECT foos.id, foos.id FROM foos ORDER BY foos.id LIMIT ?")
...
func (obj *sqlite3Impl) Find_Foo(ctx context.Context) (
	foo *Foo, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT foos.id FROM foos LIMIT 2")
...
func (obj *sqlite3Impl) Get_Foo(ctx context.Context) (
	foo *Foo, err error) {
...
func (obj *sqlite3Impl) Find_Foo_By_Id(ctx context.Context,
	...
	var __embed_stmt = __sqlbundle_Literal("SELECT foos.id FROM foos WHERE foos.id = ?")
...
func (obj *sqlite3Impl) First_Foo_By_Id(ctx context.Context,
	...
	var __embed_stmt = __sqlbundle_Literal("SELECT foos.id FROM foos WHERE foos.id = ? LIMIT 1 OFFSET 0")
...
func (obj *pgxImpl) Find_Foo(ctx context.Context) (
	foo *Foo, err error) {
...
func (obj *pgxImpl) Get_Foo(ctx context.Context) (
	foo *Foo, err error) {
...
func (obj *pgxcockroachImpl) Find_Foo(ctx context.Context) (
	foo *Foo, err error) {
...
func (obj *pgxcockroachImpl) Get_Foo(ctx context.Context) (
	foo *Foo, err error) {
...
func (obj *spannerImpl) Find_Foo(ctx context.Context) (
	foo *Foo, err error) {
...
func (obj *spannerImpl) Get_Foo(ctx context.Context) (
	foo *Foo, err error) {
