...
func (obj *spannerDB) DropSchema() []string {
	return []string{
		...
		`ALTER TABLE  orders ALTER id SET DEFAULT (null)`,
...
func (Order) _Table() string { return "orders" }

type Order_Update_Fields struct {
}

type Order_Id_Field struct {
	_set   bool
	_null  bool
	_value int64
}

func Order_Id(v int64) Order_Id_Field {
	return Order_Id_Field{_set: true, _value: v}
}

func (f Order_Id_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
type Order_CustomerId_Field struct {
	_set   bool
	_null  bool
	_value int64
}

func Order_CustomerId(v int64) Order_CustomerId_Field {
	return Order_CustomerId_Field{_set: true, _value: v}
}

func (f Order_CustomerId_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
type Order_Amount_Field struct {
	_set   bool
	_null  bool
	_value int64
}

func Order_Amount(v int64) Order_Amount_Field {
	return Order_Amount_Field{_set: true, _value: v}
}

func (f Order_Amount_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
type Order_Price_Field struct {
	_set   bool
	_null  bool
	_value float64
}

func Order_Price(v float64) Order_Price_Field {
	return Order_Price_Field{_set: true, _value: v}
}

func (f Order_Price_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
type COUNT_SUMAmount_AVGPrice_Row struct {
	COUNT     int64
	SUMAmount *int64
	AVGPrice  *float64
}

type CustomerId_AVGPrice_Row struct {
	CustomerId int64
	AVGPrice   *float64
}

type CustomerId_COUNTId_Row struct {
	CustomerId int64
	COUNTId    int64
}

type CustomerId_MINAmount_MAXAmount_Row struct {
	CustomerId int64
	MINAmount  *int64
	MAXAmount  *int64
}

type CustomerId_SUMAmount_COUNT_Row struct {
	CustomerId int64
	SUMAmount  *int64
	COUNT      int64
}

type SUMAmount_Row struct {
	SUMAmount *int64
}

func (obj *sqlite3Impl) All_Order_CustomerId_Sum_Order_Amount_Count_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_SUMAmount_COUNT_Row, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT orders.customer_id, SUM(orders.amount), COUNT(*) FROM orders GROUP BY orders.customer_id")
	...
	for {
		rows, err = func() (rows []*CustomerId_SUMAmount_COUNT_Row, err error) {
			...
			for __rows.Next() {
				row := &CustomerId_SUMAmount_COUNT_Row{}
				err = __rows.Scan(&row.CustomerId, &row.SUMAmount, &row.COUNT)
				if err != nil {
					return nil, err
				}
...
func (obj *sqlite3Impl) All_Order_CustomerId_Count_Order_Id_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_COUNTId_Row, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT orders.customer_id, COUNT(orders.id) FROM orders GROUP BY orders.customer_id")
	...
	for {
		rows, err = func() (rows []*CustomerId_COUNTId_Row, err error) {
			__rows, err := obj.driver.QueryContext(ctx, __stmt, __values...)
			if err != nil {
				return nil, err
			}
			...
			for __rows.Next() {
				row := &CustomerId_COUNTId_Row{}
				err = __rows.Scan(&row.CustomerId, &row.COUNTId)
				if err != nil {
					return nil, err
				}
				rows = append(rows, row)
...
func (obj *sqlite3Impl) Find_Sum_Order_Amount(ctx context.Context) (
	row *SUMAmount_Row, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT SUM(orders.amount) FROM orders LIMIT 2")
	...
	for {
		row, err = func() (row *SUMAmount_Row, err error) {
			__rows, err := obj.driver.QueryContext(ctx, __stmt, __values...)
			if err != nil {
				return nil, err
			}
		...
		if err != nil {
			...
			if errors.Is(err, errTooManyRows) {
				return nil, tooManyRows("Sum_Order_Amount")
			}
			return nil, obj.makeErr(err)
		}
		return row, nil
...
func (obj *sqlite3Impl) All_Order_CustomerId_Min_Order_Amount_Max_Order_Amount_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_MINAmount_MAXAmount_Row, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT orders.customer_id, MIN(orders.amount), MAX(orders.amount) FROM orders GROUP BY orders.customer_id")
	...
	for {
		rows, err = func() (rows []*CustomerId_MINAmount_MAXAmount_Row, err error) {
			__rows, err := obj.driver.QueryContext(ctx, __stmt, __values...)
			if err != nil {
				return nil, err
			}
			...
			for __rows.Next() {
				row := &CustomerId_MINAmount_MAXAmount_Row{}
				err = __rows.Scan(&row.CustomerId, &row.MINAmount, &row.MAXAmount)
				if err != nil {
					return nil, err
				}
				rows = append(rows, row)
...
func (obj *sqlite3Impl) All_Order_CustomerId_Avg_Order_Price_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_AVGPrice_Row, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT orders.customer_id, AVG(orders.price) FROM orders GROUP BY orders.customer_id")
	...
	for {
		rows, err = func() (rows []*CustomerId_AVGPrice_Row, err error) {
			__rows, err := obj.driver.QueryContext(ctx, __stmt, __values...)
			if err != nil {
				return nil, err
			}
			...
			for __rows.Next() {
				row := &CustomerId_AVGPrice_Row{}
				err = __rows.Scan(&row.CustomerId, &row.AVGPrice)
				if err != nil {
					return nil, err
				}
				rows = append(rows, row)
...
func (obj *sqlite3Impl) Find_Count_Sum_Order_Amount_Avg_Order_Price(ctx context.Context) (
	row *COUNT_SUMAmount_AVGPrice_Row, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT COUNT(*), SUM(orders.amount), AVG(orders.price) FROM orders LIMIT 2")
	...
	for {
		row, err = func() (row *COUNT_SUMAmount_AVGPrice_Row, err error) {
			__rows, err := obj.driver.QueryContext(ctx, __stmt, __values...)
			if err != nil {
				return nil, err
			}
			...
			row = &COUNT_SUMAmount_AVGPrice_Row{}
			err = __rows.Scan(&row.COUNT, &row.SUMAmount, &row.AVGPrice)
			if err != nil {
				return nil, err
			}
		...
		if err != nil {
			...
			if errors.Is(err, errTooManyRows) {
				return nil, tooManyRows("Count_Sum_Order_Amount_Avg_Order_Price")
			}
			return nil, obj.makeErr(err)
		}
		return row, nil
...
func (obj *sqlite3Impl) deleteAll(ctx context.Context) (count int64, err error) {
	...
	var __count int64
	__res, err = obj.driver.ExecContext(ctx, "DELETE FROM orders;")
	if err != nil {
...
func (obj *pgxImpl) All_Order_CustomerId_Sum_Order_Amount_Count_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_SUMAmount_COUNT_Row, err error) {
...
func (obj *pgxImpl) All_Order_CustomerId_Count_Order_Id_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_COUNTId_Row, err error) {
...
func (obj *pgxImpl) Find_Sum_Order_Amount(ctx context.Context) (
	row *SUMAmount_Row, err error) {
...
func (obj *pgxImpl) All_Order_CustomerId_Min_Order_Amount_Max_Order_Amount_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_MINAmount_MAXAmount_Row, err error) {
...
func (obj *pgxImpl) All_Order_CustomerId_Avg_Order_Price_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_AVGPrice_Row, err error) {
...
func (obj *pgxImpl) Find_Count_Sum_Order_Amount_Avg_Order_Price(ctx context.Context) (
	row *COUNT_SUMAmount_AVGPrice_Row, err error) {
...
func (obj *pgxcockroachImpl) All_Order_CustomerId_Sum_Order_Amount_Count_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_SUMAmount_COUNT_Row, err error) {
...
func (obj *pgxcockroachImpl) All_Order_CustomerId_Count_Order_Id_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_COUNTId_Row, err error) {
...
func (obj *pgxcockroachImpl) Find_Sum_Order_Amount(ctx context.Context) (
	row *SUMAmount_Row, err error) {
...
func (obj *pgxcockroachImpl) All_Order_CustomerId_Min_Order_Amount_Max_Order_Amount_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_MINAmount_MAXAmount_Row, err error) {
...
func (obj *pgxcockroachImpl) All_Order_CustomerId_Avg_Order_Price_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_AVGPrice_Row, err error) {
...
func (obj *pgxcockroachImpl) Find_Count_Sum_Order_Amount_Avg_Order_Price(ctx context.Context) (
	row *COUNT_SUMAmount_AVGPrice_Row, err error) {
...
func (obj *spannerImpl) All_Order_CustomerId_Sum_Order_Amount_Count_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_SUMAmount_COUNT_Row, err error) {
...
func (obj *spannerImpl) All_Order_CustomerId_Count_Order_Id_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_COUNTId_Row, err error) {
...
func (obj *spannerImpl) Find_Sum_Order_Amount(ctx context.Context) (
	row *SUMAmount_Row, err error) {
...
func (obj *spannerImpl) All_Order_CustomerId_Min_Order_Amount_Max_Order_Amount_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_MINAmount_MAXAmount_Row, err error) {
...
func (obj *spannerImpl) All_Order_CustomerId_Avg_Order_Price_GroupBy_CustomerId(ctx context.Context) (
	rows []*CustomerId_AVGPrice_Row, err error) {
...
func (obj *spannerImpl) Find_Count_Sum_Order_Amount_Avg_Order_Price(ctx context.Context) (
	row *COUNT_SUMAmount_AVGPrice_Row, err error) {
...
type Methods interface {
	All_Order_CustomerId_Avg_Order_Price_GroupBy_CustomerId(ctx context.Context) (
		rows []*CustomerId_AVGPrice_Row, err error)

	All_Order_CustomerId_Count_Order_Id_GroupBy_CustomerId(ctx context.Context) (
		rows []*CustomerId_COUNTId_Row, err error)

	All_Order_CustomerId_Min_Order_Amount_Max_Order_Amount_GroupBy_CustomerId(ctx context.Context) (
		rows []*CustomerId_MINAmount_MAXAmount_Row, err error)

	All_Order_CustomerId_Sum_Order_Amount_Count_GroupBy_CustomerId(ctx context.Context) (
		rows []*CustomerId_SUMAmount_COUNT_Row, err error)

	Find_Count_Sum_Order_Amount_Avg_Order_Price(ctx context.Context) (
		row *COUNT_SUMAmount_AVGPrice_Row, err error)

	Find_Sum_Order_Amount(ctx context.Context) (
		row *SUMAmount_Row, err error)
}
