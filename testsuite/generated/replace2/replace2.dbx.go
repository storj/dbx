...
func Bar_Data(v string) Bar_Data_Field {
	return Bar_Data_Field{_set: true, _value: v}
}

func (f Bar_Data_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
func Foo_Data(v string) Foo_Data_Field {
	return Foo_Data_Field{_set: true, _value: v}
}

func (f Foo_Data_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
func (obj *sqlite3Impl) ReplaceNoReturn_Foo(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_data Foo_Data_Field) (
	err error) {
	__pk_val := foo_pk.value()
	__data_val := foo_data.value()

	var __embed_stmt = __sqlbundle_Literal("REPLACE INTO foos ( pk, data ) VALUES ( ?, ? )")

	var __values []any
	__values = append(__values, __pk_val, __data_val)
...
func (obj *sqlite3Impl) Replace_Foo(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_data Foo_Data_Field) (
	foo *Foo, err error) {
	__pk_val := foo_pk.value()
	...
	var __embed_stmt = __sqlbundle_Literal("REPLACE INTO foos ( pk, data ) VALUES ( ?, ? ) RETURNING foos.pk, foos.data")
	...
	foo = &Foo{}
	err = obj.queryRowContext(ctx, __stmt, __values...).Scan(&foo.Pk, &foo.Data)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	return foo, nil
...
func (obj *sqlite3Impl) RawReplace_Bar(ctx context.Context,
	raw_bar *Bar) (
	bar *Bar, err error) {

	__pk_val := Bar_Pk(raw_bar.Pk).value()
	__data_val := Bar_Data(raw_bar.Data).value()

	var __embed_stmt = __sqlbundle_Literal("REPLACE INTO bars ( pk, data ) VALUES ( ?, ? ) RETURNING bars.pk, bars.data")

	var __stmt = __sqlbundle_Render(obj.dialect, __embed_stmt)
	obj.logStmt(__stmt, __pk_val, __data_val)

	bar = &Bar{}
	err = obj.queryRowContext(ctx, __stmt, __pk_val, __data_val).Scan(&bar.Pk, &bar.Data)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	return bar, nil
...
func (obj *sqlite3Impl) RawReplaceNoReturn_Bar(ctx context.Context,
	raw_bar *Bar) (
	err error) {
	...
	var __embed_stmt = __sqlbundle_Literal("REPLACE INTO bars ( pk, data ) VALUES ( ?, ? )")

	var __stmt = __sqlbundle_Render(obj.dialect, __embed_stmt)
	obj.logStmt(__stmt, __pk_val, __data_val)

	_, err = obj.driver.ExecContext(ctx, __stmt, __pk_val, __data_val)
	if err != nil {
		return obj.makeErr(err)
	}
	return nil
...
func (obj *pgxImpl) ReplaceNoReturn_Foo(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_data Foo_Data_Field) (
	err error) {
	__pk_val := foo_pk.value()
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT INTO foos ( pk, data ) VALUES ( ?, ? ) ON CONFLICT ( pk ) DO UPDATE SET pk = EXCLUDED.pk, data = EXCLUDED.data")
...
func (obj *pgxImpl) Replace_Foo(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_data Foo_Data_Field) (
	foo *Foo, err error) {
	__pk_val := foo_pk.value()
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT INTO foos ( pk, data ) VALUES ( ?, ? ) ON CONFLICT ( pk ) DO UPDATE SET pk = EXCLUDED.pk, data = EXCLUDED.data RETURNING foos.pk, foos.data")
...
func (obj *pgxImpl) RawReplace_Bar(ctx context.Context,
	raw_bar *Bar) (
	bar *Bar, err error) {
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT INTO bars ( pk, data ) VALUES ( ?, ? ) ON CONFLICT ( pk ) DO UPDATE SET pk = EXCLUDED.pk, data = EXCLUDED.data RETURNING bars.pk, bars.data")
...
func (obj *pgxImpl) RawReplaceNoReturn_Bar(ctx context.Context,
	raw_bar *Bar) (
	err error) {
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT INTO bars ( pk, data ) VALUES ( ?, ? ) ON CONFLICT ( pk ) DO UPDATE SET pk = EXCLUDED.pk, data = EXCLUDED.data")
...
func (obj *pgxcockroachImpl) ReplaceNoReturn_Foo(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_data Foo_Data_Field) (
	err error) {
	__pk_val := foo_pk.value()
	...
	var __embed_stmt = __sqlbundle_Literal("UPSERT INTO foos ( pk, data ) VALUES ( ?, ? )")
...
func (obj *pgxcockroachImpl) Replace_Foo(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_data Foo_Data_Field) (
	foo *Foo, err error) {
	__pk_val := foo_pk.value()
	...
	var __embed_stmt = __sqlbundle_Literal("UPSERT INTO foos ( pk, data ) VALUES ( ?, ? ) RETURNING foos.pk, foos.data")
...
func (obj *pgxcockroachImpl) RawReplace_Bar(ctx context.Context,
	raw_bar *Bar) (
	bar *Bar, err error) {
	...
	var __embed_stmt = __sqlbundle_Literal("UPSERT INTO bars ( pk, data ) VALUES ( ?, ? ) RETURNING bars.pk, bars.data")
...
func (obj *pgxcockroachImpl) RawReplaceNoReturn_Bar(ctx context.Context,
	raw_bar *Bar) (
	err error) {
	...
	var __embed_stmt = __sqlbundle_Literal("UPSERT INTO bars ( pk, data ) VALUES ( ?, ? )")
...
func (obj *spannerImpl) ReplaceNoReturn_Foo(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_data Foo_Data_Field) (
	err error) {
	__pk_val := foo_pk.value()
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT OR UPDATE INTO foos ( pk, data ) VALUES ( ?, ? )")
...
func (obj *spannerImpl) Replace_Foo(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_data Foo_Data_Field) (
	foo *Foo, err error) {
	__pk_val := foo_pk.value()
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT OR UPDATE INTO foos ( pk, data ) VALUES ( ?, ? ) THEN RETURN foos.pk, foos.data")
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&foo.Pk, &foo.Data)
	if !obj.txn {
		if err == nil {
...
func (obj *spannerImpl) RawReplace_Bar(ctx context.Context,
	raw_bar *Bar) (
	bar *Bar, err error) {
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT OR UPDATE INTO bars ( pk, data ) VALUES ( ?, ? ) THEN RETURN bars.pk, bars.data")
...
func (obj *spannerImpl) RawReplaceNoReturn_Bar(ctx context.Context,
	raw_bar *Bar) (
	err error) {
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT OR UPDATE INTO bars ( pk, data ) VALUES ( ?, ? )")
