...
func (obj *sqlite3Impl) All_Foo(ctx context.Context) (
	...
	var __embed_stmt = __sqlbundle_Literal("SELECT foos.pk, foos.data FROM foos")
	...
	for {
		rows, err = func() (rows []*Foo, err error) {
			...
			for __rows.Next() {
				foo := &Foo{}
				err = __rows.Scan(&foo.Pk, &foo.Data)
				if err != nil {
					return nil, err
				}
...
func (obj *sqlite3Impl) Update_Foo_By_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	...
	var __embed_stmt = __sqlbundle_Literals{Join: "", SQLs: []__sqlbundle_SQL{__sqlbundle_Literal("UPDATE foos SET "), __sets, __sqlbundle_Literal(" WHERE foos.pk = ? RETURNING foos.pk, foos.data")}}
	...
	__args = append(__args, foo_pk.value())
...
func (obj *sqlite3Impl) Delete_Foo_By_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field) (
	deleted bool, err error) {

	var __embed_stmt = __sqlbundle_Literal("DELETE FROM foos WHERE foos.pk = ?")
...
func (obj *pgxImpl) Update_Foo_By_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	update Foo_Update_Fields) (
	foo *Foo, err error) {
...
func (obj *pgxImpl) Delete_Foo_By_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field) (
	deleted bool, err error) {
...
func (obj *pgxcockroachImpl) Update_Foo_By_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	update Foo_Update_Fields) (
	foo *Foo, err error) {
...
func (obj *pgxcockroachImpl) Delete_Foo_By_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field) (
	deleted bool, err error) {
...
func (obj *spannerImpl) Update_Foo_By_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	update Foo_Update_Fields) (
	foo *Foo, err error) {
	...
	var __embed_stmt = __sqlbundle_Literals{Join: "", SQLs: []__sqlbundle_SQL{__sqlbundle_Literal("UPDATE foos SET "), __sets, __sqlbundle_Literal(" WHERE foos.pk = ? THEN RETURN foos.pk, foos.data")}}
...
func (obj *spannerImpl) Delete_Foo_By_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field) (
	deleted bool, err error) {
...
type Methods interface {
	...
	Delete_Foo_By_Pk(ctx context.Context,
		foo_pk Foo_Pk_Field) (
		deleted bool, err error)

	Update_Foo_By_Pk(ctx context.Context,
		foo_pk Foo_Pk_Field,
		update Foo_Update_Fields) (
		foo *Foo, err error)
}
