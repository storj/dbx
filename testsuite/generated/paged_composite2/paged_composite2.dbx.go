...
type Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId_Continuation struct {
...
type Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual_Continuation struct {
	_value_expires_at      time.Time
	_value_storage_node_id []byte
	_value_project_id      []byte
	_value_bucket_name     []byte
...
func (obj *sqlite3Impl) ReplaceNoReturn_ConsumedSerial(ctx context.Context,
	...
	var __embed_stmt = __sqlbundle_Literal("REPLACE INTO consumed_serials ( expires_at, storage_node_id, project_id, bucket_name, action, serial_number, settled ) VALUES ( ?, ?, ?, ?, ?, ?, ? )")
...
func (obj *sqlite3Impl) Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual(ctx context.Context,
	consumed_serial_expires_at_less_or_equal ConsumedSerial_ExpiresAt_Field,
	limit int, start *Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual_Continuation) (
	rows []*ConsumedSerial, next *Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual_Continuation, err error) {
	...
	for {
		rows, next, err = func() (rows []*ConsumedSerial, next *Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual_Continuation, err error) {
...
func (obj *sqlite3Impl) Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId(ctx context.Context,
	consumed_serial_expires_at_greater ConsumedSerial_ExpiresAt_Field,
	consumed_serial_storage_node_id ConsumedSerial_StorageNodeId_Field,
	limit int, start *Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId_Continuation) (
	rows []*ConsumedSerial, next *Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId_Continuation, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT consumed_serials.expires_at, consumed_serials.storage_node_id, consumed_serials.project_id, consumed_serials.bucket_name, consumed_serials.action, consumed_serials.serial_number, consumed_serials.settled, consumed_serials.expires_at, consumed_serials.storage_node_id, consumed_serials.project_id, consumed_serials.bucket_name, consumed_serials.action, consumed_serials.serial_number FROM consumed_serials WHERE consumed_serials.expires_at > ? AND consumed_serials.storage_node_id = ? AND (consumed_serials.expires_at, consumed_serials.storage_node_id, consumed_serials.project_id, consumed_serials.bucket_name, consumed_serials.action, consumed_serials.serial_number) > (?, ?, ?, ?, ?, ?) ORDER BY consumed_serials.expires_at, consumed_serials.storage_node_id, consumed_serials.project_id, consumed_serials.bucket_name, consumed_serials.action, consumed_serials.serial_number LIMIT ?")

	var __embed_first_stmt = __sqlbundle_Literal("SELECT consumed_serials.expires_at, consumed_serials.storage_node_id, consumed_serials.project_id, consumed_serials.bucket_name, consumed_serials.action, consumed_serials.serial_number, consumed_serials.settled, consumed_serials.expires_at, consumed_serials.storage_node_id, consumed_serials.project_id, consumed_serials.bucket_name, consumed_serials.action, consumed_serials.serial_number FROM consumed_serials WHERE consumed_serials.expires_at > ? AND consumed_serials.storage_node_id = ? ORDER BY consumed_serials.expires_at, consumed_serials.storage_node_id, consumed_serials.project_id, consumed_serials.bucket_name, consumed_serials.action, consumed_serials.serial_number LIMIT ?")

	var __values []any
	__values = append(__values, consumed_serial_expires_at_greater.value(), consumed_serial_storage_node_id.value())
	...
	for {
		rows, next, err = func() (rows []*ConsumedSerial, next *Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId_Continuation, err error) {
			__rows, err := obj.driver.QueryContext(ctx, __stmt, __values...)
			if err != nil {
				return nil, nil, err
			}
...
func (obj *pgxImpl) ReplaceNoReturn_ConsumedSerial(ctx context.Context,
	consumed_serial_expires_at ConsumedSerial_ExpiresAt_Field,
	consumed_serial_storage_node_id ConsumedSerial_StorageNodeId_Field,
	consumed_serial_project_id ConsumedSerial_ProjectId_Field,
	consumed_serial_bucket_name ConsumedSerial_BucketName_Field,
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT INTO consumed_serials ( expires_at, storage_node_id, project_id, bucket_name, action, serial_number, settled ) VALUES ( ?, ?, ?, ?, ?, ?, ? ) ON CONFLICT ( expires_at, storage_node_id, project_id, bucket_name, action, serial_number ) DO UPDATE SET expires_at = EXCLUDED.expires_at, storage_node_id = EXCLUDED.storage_node_id, project_id = EXCLUDED.project_id, bucket_name = EXCLUDED.bucket_name, action = EXCLUDED.action, serial_number = EXCLUDED.serial_number, settled = EXCLUDED.settled")
...
func (obj *pgxImpl) Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual(ctx context.Context,
	consumed_serial_expires_at_less_or_equal ConsumedSerial_ExpiresAt_Field,
	limit int, start *Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual_Continuation) (
	rows []*ConsumedSerial, next *Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual_Continuation, err error) {
...
func (obj *pgxImpl) Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId(ctx context.Context,
	consumed_serial_expires_at_greater ConsumedSerial_ExpiresAt_Field,
	consumed_serial_storage_node_id ConsumedSerial_StorageNodeId_Field,
	limit int, start *Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId_Continuation) (
	rows []*ConsumedSerial, next *Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId_Continuation, err error) {
...
func (obj *pgxcockroachImpl) ReplaceNoReturn_ConsumedSerial(ctx context.Context,
	consumed_serial_expires_at ConsumedSerial_ExpiresAt_Field,
	consumed_serial_storage_node_id ConsumedSerial_StorageNodeId_Field,
	consumed_serial_project_id ConsumedSerial_ProjectId_Field,
	consumed_serial_bucket_name ConsumedSerial_BucketName_Field,
	...
	var __embed_stmt = __sqlbundle_Literal("UPSERT INTO consumed_serials ( expires_at, storage_node_id, project_id, bucket_name, action, serial_number, settled ) VALUES ( ?, ?, ?, ?, ?, ?, ? )")
...
func (obj *pgxcockroachImpl) Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual(ctx context.Context,
	consumed_serial_expires_at_less_or_equal ConsumedSerial_ExpiresAt_Field,
	limit int, start *Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual_Continuation) (
	rows []*ConsumedSerial, next *Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual_Continuation, err error) {
...
func (obj *pgxcockroachImpl) Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId(ctx context.Context,
	consumed_serial_expires_at_greater ConsumedSerial_ExpiresAt_Field,
	consumed_serial_storage_node_id ConsumedSerial_StorageNodeId_Field,
	limit int, start *Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId_Continuation) (
	rows []*ConsumedSerial, next *Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId_Continuation, err error) {
...
func (obj *spannerImpl) ReplaceNoReturn_ConsumedSerial(ctx context.Context,
	consumed_serial_expires_at ConsumedSerial_ExpiresAt_Field,
	consumed_serial_storage_node_id ConsumedSerial_StorageNodeId_Field,
	consumed_serial_project_id ConsumedSerial_ProjectId_Field,
	consumed_serial_bucket_name ConsumedSerial_BucketName_Field,
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT OR UPDATE INTO consumed_serials ( expires_at, storage_node_id, project_id, bucket_name, action, serial_number, settled ) VALUES ( ?, ?, ?, ?, ?, ?, ? )")
...
func (obj *spannerImpl) Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual(ctx context.Context,
	consumed_serial_expires_at_less_or_equal ConsumedSerial_ExpiresAt_Field,
	limit int, start *Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual_Continuation) (
	rows []*ConsumedSerial, next *Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual_Continuation, err error) {
...
func (obj *spannerImpl) Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId(ctx context.Context,
	consumed_serial_expires_at_greater ConsumedSerial_ExpiresAt_Field,
	consumed_serial_storage_node_id ConsumedSerial_StorageNodeId_Field,
	limit int, start *Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId_Continuation) (
	rows []*ConsumedSerial, next *Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId_Continuation, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT consumed_serials.expires_at, consumed_serials.storage_node_id, consumed_serials.project_id, consumed_serials.bucket_name, consumed_serials.action, consumed_serials.serial_number, consumed_serials.settled, consumed_serials.expires_at, consumed_serials.storage_node_id, consumed_serials.project_id, consumed_serials.bucket_name, consumed_serials.action, consumed_serials.serial_number FROM consumed_serials WHERE consumed_serials.expires_at > ? AND consumed_serials.storage_node_id = ? AND (consumed_serials.expires_at > ? OR (consumed_serials.expires_at = ? AND (consumed_serials.storage_node_id > ? OR (consumed_serials.storage_node_id = ? AND (consumed_serials.project_id > ? OR (consumed_serials.project_id = ? AND (consumed_serials.bucket_name > ? OR (consumed_serials.bucket_name = ? AND (consumed_serials.action > ? OR (consumed_serials.action = ? AND consumed_serials.serial_number > ?)))))))))) ORDER BY consumed_serials.expires_at, consumed_serials.storage_node_id, consumed_serials.project_id, consumed_serials.bucket_name, consumed_serials.action, consumed_serials.serial_number LIMIT ?")
...
type Methods interface {
	...
	Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId(ctx context.Context,
		consumed_serial_expires_at_greater ConsumedSerial_ExpiresAt_Field,
		consumed_serial_storage_node_id ConsumedSerial_StorageNodeId_Field,
		limit int, start *Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId_Continuation) (
		rows []*ConsumedSerial, next *Paged_ConsumedSerial_By_ExpiresAt_Greater_And_StorageNodeId_Continuation, err error)

	Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual(ctx context.Context,
		consumed_serial_expires_at_less_or_equal ConsumedSerial_ExpiresAt_Field,
		limit int, start *Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual_Continuation) (
		rows []*ConsumedSerial, next *Paged_ConsumedSerial_By_ExpiresAt_LessOrEqual_Continuation, err error)

	ReplaceNoReturn_ConsumedSerial(ctx context.Context,
		consumed_serial_expires_at ConsumedSerial_ExpiresAt_Field,
		consumed_serial_storage_node_id ConsumedSerial_StorageNodeId_Field,
		consumed_serial_project_id ConsumedSerial_ProjectId_Field,
		consumed_serial_bucket_name ConsumedSerial_BucketName_Field,
