...
func (obj *sqlite3Impl) Create_Person(ctx context.Context,
	...
	person = &Person{}
	err = obj.queryRowContext(ctx, __stmt, __values...).Scan(&person.Pk, &person.Name, &person.Value, &person.ValueUp, &person.ValueNull, &person.ValueNullUp)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	return person, nil
...
func (obj *sqlite3Impl) Get_Person_By_Value_And_ValueUp_And_ValueNull_And_ValueNullUp(ctx context.Context,
	...
	for {
		person, err = func() (person *Person, err error) {
...
func (obj *spannerImpl) Create_Person(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&person.Pk, &person.Name, &person.Value, &person.ValueUp, &person.ValueNull, &person.ValueNullUp)
	if !obj.txn {
		if err == nil {
