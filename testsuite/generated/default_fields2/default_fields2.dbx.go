...
func Foo_D(v int) Foo_D_Field {
	return Foo_D_Field{_set: true, _value: v}
}

func (f Foo_D_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
func Foo_E(v string) Foo_E_Field {
	return Foo_E_Field{_set: true, _value: v}
}

func (f Foo_E_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
func Foo_F(v time.Time) Foo_F_Field {
	return Foo_F_Field{_set: true, _value: v}
}

func (f Foo_F_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
func (obj *sqlite3Impl) CreateNoReturn_Foo(ctx context.Context,
	...
	if optional.D._set {
		__values = append(__values, optional.D.value())
		__optional_columns.SQLs = append(__optional_columns.SQLs, __sqlbundle_Literal("d"))
		__optional_placeholders.SQLs = append(__optional_placeholders.SQLs, __sqlbundle_Literal("?"))
	}

	if optional.E._set {
		__values = append(__values, optional.E.value())
		__optional_columns.SQLs = append(__optional_columns.SQLs, __sqlbundle_Literal("e"))
		__optional_placeholders.SQLs = append(__optional_placeholders.SQLs, __sqlbundle_Literal("?"))
	}

	if optional.F._set {
		__values = append(__values, optional.F.value())
		__optional_columns.SQLs = append(__optional_columns.SQLs, __sqlbundle_Literal("f"))
		__optional_placeholders.SQLs = append(__optional_placeholders.SQLs, __sqlbundle_Literal("?"))
	}
...
func (obj *sqlite3Impl) CreateNoReturn_Bar(ctx context.Context,
	bar_a Bar_A_Field,
	bar_b Bar_B_Field,
...
func (obj *sqlite3Impl) CreateNoReturn_Baz(ctx context.Context,
...
func (obj *sqlite3Impl) Get_Foo_By_Pk(ctx context.Context,
	...
	var __embed_stmt = __sqlbundle_Literal("SELECT foos.pk, foos.a, foos.b, foos.c, foos.d, foos.e, foos.f FROM foos WHERE foos.pk = ?")
	...
	foo = &Foo{}
	err = obj.queryRowContext(ctx, __stmt, __values...).Scan(&foo.Pk, &foo.A, &foo.B, &foo.C, &foo.D, &foo.E, &foo.F)
	if err != nil {
...
func (obj *sqlite3Impl) Get_Bar_By_Pk(ctx context.Context,
	...
	bar = &Bar{}
	err = obj.queryRowContext(ctx, __stmt, __values...).Scan(&bar.Pk, &bar.A, &bar.B, &bar.C)
	if err != nil {
...
func (obj *sqlite3Impl) Get_Baz_By_Pk(ctx context.Context,
	...
	baz = &Baz{}
	err = obj.queryRowContext(ctx, __stmt, __values...).Scan(&baz.Pk, &baz.A, &baz.B, &baz.C)
	if err != nil {
...
func (obj *pgxImpl) CreateNoReturn_Bar(ctx context.Context,
	bar_a Bar_A_Field,
	bar_b Bar_B_Field,
	optional Bar_Create_Fields) (
	err error) {
...
func (obj *pgxImpl) CreateNoReturn_Baz(ctx context.Context,
	optional Baz_Create_Fields) (
	err error) {
...
func (obj *pgxcockroachImpl) CreateNoReturn_Bar(ctx context.Context,
	bar_a Bar_A_Field,
	bar_b Bar_B_Field,
	optional Bar_Create_Fields) (
	err error) {
...
func (obj *pgxcockroachImpl) CreateNoReturn_Baz(ctx context.Context,
	optional Baz_Create_Fields) (
	err error) {
...
func (obj *spannerImpl) CreateNoReturn_Bar(ctx context.Context,
	bar_a Bar_A_Field,
	bar_b Bar_B_Field,
	optional Bar_Create_Fields) (
	err error) {
...
func (obj *spannerImpl) CreateNoReturn_Baz(ctx context.Context,
	optional Baz_Create_Fields) (
	err error) {
...
type Methods interface {
	CreateNoReturn_Bar(ctx context.Context,
		bar_a Bar_A_Field,
		bar_b Bar_B_Field,
		optional Bar_Create_Fields) (
		err error)

	CreateNoReturn_Baz(ctx context.Context,
		optional Baz_Create_Fields) (
		err error)
