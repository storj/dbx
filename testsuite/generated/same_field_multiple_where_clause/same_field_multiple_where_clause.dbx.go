...
package same_field_multiple_where_clause
...
func (obj *sqlite3Impl) All_Foo_By_Pk_Greater_And_Pk_Less(ctx context.Context,
	foo_pk_greater Foo_Pk_Field,
	foo_pk_less Foo_Pk_Field) (
	rows []*Foo, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT foos.pk, foos.u FROM foos WHERE foos.pk > ? AND foos.pk < ?")

	var __values []any
	__values = append(__values, foo_pk_greater.value(), foo_pk_less.value())
...
func (obj *sqlite3Impl) Update_Foo_By_Pk_Less_And_Pk(ctx context.Context,
	foo_pk_less Foo_Pk_Field,
	foo_pk Foo_Pk_Field,
	...
	var __embed_stmt = __sqlbundle_Literals{Join: "", SQLs: []__sqlbundle_SQL{__sqlbundle_Literal("UPDATE foos SET "), __sets, __sqlbundle_Literal(" WHERE foos.pk < ? AND foos.pk = ? RETURNING foos.pk, foos.u")}}
	...
	if update.U._set {
		__values = append(__values, update.U.value())
	...
	__args = append(__args, foo_pk_less.value(), foo_pk.value())
...
func (obj *sqlite3Impl) Delete_Foo_By_Pk_Less_And_Pk(ctx context.Context,
	foo_pk_less Foo_Pk_Field,
	foo_pk Foo_Pk_Field) (
	deleted bool, err error) {

	var __embed_stmt = __sqlbundle_Literal("DELETE FROM foos WHERE foos.pk < ? AND foos.pk = ?")

	var __values []any
	__values = append(__values, foo_pk_less.value(), foo_pk.value())
...
func (obj *pgxImpl) All_Foo_By_Pk_Greater_And_Pk_Less(ctx context.Context,
	foo_pk_greater Foo_Pk_Field,
	foo_pk_less Foo_Pk_Field) (
	rows []*Foo, err error) {
...
func (obj *pgxImpl) Update_Foo_By_Pk_Less_And_Pk(ctx context.Context,
	foo_pk_less Foo_Pk_Field,
	foo_pk Foo_Pk_Field,
	update Foo_Update_Fields) (
	foo *Foo, err error) {
...
func (obj *pgxImpl) Delete_Foo_By_Pk_Less_And_Pk(ctx context.Context,
	foo_pk_less Foo_Pk_Field,
	foo_pk Foo_Pk_Field) (
	deleted bool, err error) {
...
func (obj *pgxcockroachImpl) All_Foo_By_Pk_Greater_And_Pk_Less(ctx context.Context,
	foo_pk_greater Foo_Pk_Field,
	foo_pk_less Foo_Pk_Field) (
	rows []*Foo, err error) {
...
func (obj *pgxcockroachImpl) Update_Foo_By_Pk_Less_And_Pk(ctx context.Context,
	foo_pk_less Foo_Pk_Field,
	foo_pk Foo_Pk_Field,
	update Foo_Update_Fields) (
	foo *Foo, err error) {
...
func (obj *pgxcockroachImpl) Delete_Foo_By_Pk_Less_And_Pk(ctx context.Context,
	foo_pk_less Foo_Pk_Field,
	foo_pk Foo_Pk_Field) (
	deleted bool, err error) {
...
func (obj *spannerImpl) All_Foo_By_Pk_Greater_And_Pk_Less(ctx context.Context,
	foo_pk_greater Foo_Pk_Field,
	foo_pk_less Foo_Pk_Field) (
	rows []*Foo, err error) {
...
func (obj *spannerImpl) Update_Foo_By_Pk_Less_And_Pk(ctx context.Context,
	foo_pk_less Foo_Pk_Field,
	foo_pk Foo_Pk_Field,
	update Foo_Update_Fields) (
	foo *Foo, err error) {
	...
	var __embed_stmt = __sqlbundle_Literals{Join: "", SQLs: []__sqlbundle_SQL{__sqlbundle_Literal("UPDATE foos SET "), __sets, __sqlbundle_Literal(" WHERE foos.pk < ? AND foos.pk = ? THEN RETURN foos.pk, foos.u")}}
	...
	if !obj.txn {
		...
		err = obj.db.DB.QueryRowContext(ctx, __stmt, __values...).Scan(&foo.Pk, &foo.U)
	}
	if err == sql.ErrNoRows {
		return nil, nil
	}
...
func (obj *spannerImpl) Delete_Foo_By_Pk_Less_And_Pk(ctx context.Context,
	foo_pk_less Foo_Pk_Field,
	foo_pk Foo_Pk_Field) (
	deleted bool, err error) {
...
type Methods interface {
	All_Foo_By_Pk_Greater_And_Pk_Less(ctx context.Context,
		foo_pk_greater Foo_Pk_Field,
		foo_pk_less Foo_Pk_Field) (
		rows []*Foo, err error)

	Delete_Foo_By_Pk_Less_And_Pk(ctx context.Context,
		foo_pk_less Foo_Pk_Field,
		foo_pk Foo_Pk_Field) (
		deleted bool, err error)

	Update_Foo_By_Pk_Less_And_Pk(ctx context.Context,
		foo_pk_less Foo_Pk_Field,
		foo_pk Foo_Pk_Field,
		update Foo_Update_Fields) (
		foo *Foo, err error)
