...
type Foo struct {
	...
	Data           float32
	Data64         float64
	NullableData   *float32
	NullableData64 *float64
}

func (Foo) _Table() string { return "foos" }

type Foo_Create_Fields struct {
	NullableData   Foo_NullableData_Field
	NullableData64 Foo_NullableData64_Field
}
...
func Foo_Data64(v float64) Foo_Data64_Field {
	return Foo_Data64_Field{_set: true, _value: v}
}

func (f Foo_Data64_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
func Foo_NullableData(v float32) Foo_NullableData_Field {
	return Foo_NullableData_Field{_set: true, _value: &v}
}

func Foo_NullableData_Raw(v *float32) Foo_NullableData_Field {
	if v == nil {
		return Foo_NullableData_Null()
	}
	return Foo_NullableData(*v)
}

func Foo_NullableData_Null() Foo_NullableData_Field {
	return Foo_NullableData_Field{_set: true, _null: true}
}

func (f Foo_NullableData_Field) isnull() bool { return !f._set || f._null || f._value == nil }

func (f Foo_NullableData_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
func Foo_NullableData64(v float64) Foo_NullableData64_Field {
	return Foo_NullableData64_Field{_set: true, _value: &v}
}

func Foo_NullableData64_Raw(v *float64) Foo_NullableData64_Field {
	if v == nil {
		return Foo_NullableData64_Null()
	}
	return Foo_NullableData64(*v)
}

func Foo_NullableData64_Null() Foo_NullableData64_Field {
	return Foo_NullableData64_Field{_set: true, _null: true}
}

func (f Foo_NullableData64_Field) isnull() bool { return !f._set || f._null || f._value == nil }

func (f Foo_NullableData64_Field) value() any {
	if !f._set || f._null {
		return nil
	}
	return f._value
