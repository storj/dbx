...
func (obj *sqlite3Impl) Create_Session(ctx context.Context,
	...
	session = &Session{}
	err = obj.queryRowContext(ctx, __stmt, __values...).Scan(&session.Id, &session.UserPk)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	return session, nil
...
func (obj *sqlite3Impl) Create_User(ctx context.Context) (
	...
	user = &User{}
	err = obj.queryRowContext(ctx, __stmt, __values...).Scan(&user.Pk)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	return user, nil
...
func (obj *sqlite3Impl) Create_AssociatedAccount(ctx context.Context,
	...
	err = obj.queryRowContext(ctx, __stmt, __values...).Scan(&associated_account.Pk, &associated_account.UserPk)
	if err != nil {
		return nil, obj.makeErr(err)
	}
...
func (obj *spannerImpl) Create_Session(ctx context.Context,
	...
	if !obj.txn {
		err = obj.withTx(ctx, func(tx *sql.Tx) error {
			return tx.QueryRowContext(ctx, __stmt, __values...).Scan(&session.Id, &session.UserPk)
		})
	} else {
...
func (obj *spannerImpl) Create_User(ctx context.Context) (
	...
	if !obj.txn {
		err = obj.withTx(ctx, func(tx *sql.Tx) error {
			return tx.QueryRowContext(ctx, __stmt, __values...).Scan(&user.Pk)
		})
	} else {
...
func (obj *spannerImpl) Create_AssociatedAccount(ctx context.Context,
	...
	if !obj.txn {
		err = obj.withTx(ctx, func(tx *sql.Tx) error {
			return tx.QueryRowContext(ctx, __stmt, __values...).Scan(&associated_account.Pk, &associated_account.UserPk)
		})
	} else {
