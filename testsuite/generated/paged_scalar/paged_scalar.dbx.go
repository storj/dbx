...
func (obj *spannerImpl) Create_DataBlob(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_blob.Id)
	if !obj.txn {
		if err == nil {
...
func (obj *spannerImpl) Create_DataDate(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_date.Id)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_DataFloat(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_float.Id)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_DataFloat64(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_float64.Id)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_DataInt(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_int.Id)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_DataInt64(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_int64.Id)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_DataJson(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(spannerConvertJSON(&data_json.Id))
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_DataSerial(ctx context.Context) (
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_serial.Id)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_DataSerial64(ctx context.Context) (
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_serial64.Id)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_DataText(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_text.Id)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_DataTimestamp(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_timestamp.Id)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_DataUint(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_uint.Id)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_DataUint64(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_uint64.Id)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
...
func (obj *spannerImpl) Create_DataUtimestamp(ctx context.Context,
	...
	err = __d.QueryRowContext(ctx, __stmt, __values...).Scan(&data_utimestamp.Id)
	if !obj.txn {
		if err == nil {
			err = obj.makeErr(tx.Commit())
		}
