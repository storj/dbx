...
func (obj *sqlite3Impl) Create_Foo(ctx context.Context,
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT INTO foos ( data ) VALUES ( ? ) RETURNING foos.pk, foos.data")

	var __values []any
	__values = append(__values, __data_val)
...
func (obj *sqlite3Impl) Get_Foo_By_Pk_And_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_pk_2 Foo_Pk_Field) (
	foo *Foo, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT foos.pk, foos.data FROM foos WHERE foos.pk = ? AND foos.pk = ?")

	var __values []any
	__values = append(__values, foo_pk.value(), foo_pk_2.value())
...
func (obj *sqlite3Impl) Update_Foo_By_Pk_And_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_pk_2 Foo_Pk_Field,
	...
	var __embed_stmt = __sqlbundle_Literals{Join: "", SQLs: []__sqlbundle_SQL{__sqlbundle_Literal("UPDATE foos SET "), __sets, __sqlbundle_Literal(" WHERE foos.pk = ? AND foos.pk = ? RETURNING foos.pk, foos.data")}}
	...
	__args = append(__args, foo_pk.value(), foo_pk_2.value())
...
func (obj *sqlite3Impl) Delete_Foo_By_Pk_And_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_pk_2 Foo_Pk_Field) (
...
func (obj *pgxImpl) Get_Foo_By_Pk_And_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_pk_2 Foo_Pk_Field) (
	foo *Foo, err error) {
...
func (obj *pgxImpl) Update_Foo_By_Pk_And_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_pk_2 Foo_Pk_Field,
	update Foo_Update_Fields) (
	foo *Foo, err error) {
...
func (obj *pgxImpl) Delete_Foo_By_Pk_And_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_pk_2 Foo_Pk_Field) (
	deleted bool, err error) {
...
func (obj *pgxcockroachImpl) Get_Foo_By_Pk_And_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_pk_2 Foo_Pk_Field) (
	foo *Foo, err error) {
...
func (obj *pgxcockroachImpl) Update_Foo_By_Pk_And_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_pk_2 Foo_Pk_Field,
	update Foo_Update_Fields) (
	foo *Foo, err error) {
...
func (obj *pgxcockroachImpl) Delete_Foo_By_Pk_And_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_pk_2 Foo_Pk_Field) (
	deleted bool, err error) {
...
func (obj *spannerImpl) Create_Foo(ctx context.Context,
	...
	var __embed_stmt = __sqlbundle_Literal("INSERT INTO foos ( data ) VALUES ( ? ) THEN RETURN foos.pk, foos.data")
...
func (obj *spannerImpl) Get_Foo_By_Pk_And_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_pk_2 Foo_Pk_Field) (
	foo *Foo, err error) {
...
func (obj *spannerImpl) Update_Foo_By_Pk_And_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_pk_2 Foo_Pk_Field,
	update Foo_Update_Fields) (
	foo *Foo, err error) {
	...
	var __embed_stmt = __sqlbundle_Literals{Join: "", SQLs: []__sqlbundle_SQL{__sqlbundle_Literal("UPDATE foos SET "), __sets, __sqlbundle_Literal(" WHERE foos.pk = ? AND foos.pk = ? THEN RETURN foos.pk, foos.data")}}
...
func (obj *spannerImpl) Delete_Foo_By_Pk_And_Pk(ctx context.Context,
	foo_pk Foo_Pk_Field,
	foo_pk_2 Foo_Pk_Field) (
	deleted bool, err error) {
...
type Methods interface {
	...
	Delete_Foo_By_Pk_And_Pk(ctx context.Context,
		foo_pk Foo_Pk_Field,
		foo_pk_2 Foo_Pk_Field) (
		deleted bool, err error)

	Get_Foo_By_Pk_And_Pk(ctx context.Context,
		foo_pk Foo_Pk_Field,
		foo_pk_2 Foo_Pk_Field) (
		foo *Foo, err error)

	Update_Foo_By_Pk_And_Pk(ctx context.Context,
		foo_pk Foo_Pk_Field,
		foo_pk_2 Foo_Pk_Field,
		update Foo_Update_Fields) (
		foo *Foo, err error)
